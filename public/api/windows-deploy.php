...
$lines[] = 'VIRTIO_FOUND=""';
$lines[] = '# Search for VirtIO ISO via Proxmox storage API (authoritative)';
...
$lines[] = 'fi';
$lines[] = '# Fallback: download if not found';
$lines[] = 'if [ -z "$VIRTIO_FOUND" ]; then';
$lines[] = '  echo "    VirtIO ISO not found on $ISO_STOR — downloading..."';
